      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className=" mx-auto text-center pb-12 md:pb-16">
            <h2 className="text-6xl max-sm:text-2xl font-bold mb-4">
              Trusted by over 20,000 companies all over the world
            </h2>
            <p
              className="text-xl max-sm:text-base text-gray-600"
              data-aos="zoom-y-out"
            >
            ...
            <div className="relative flex items-start border-2 border-gray-200 rounded bg-white">
              ...
              <div className="text-center px-12 py-8 pt-20 mx-4 md:mx-0">
                <div className="absolute top-0 -mt-8 left-1/2 transform -translate-x-1/2">
                  ...
                  <img
                    className="relative rounded-full object-cover h-28 bg-red-50"
