    ...
    <>
      ...
      >
        <div class="relative z-10 flex flex-col justify-center items-center mt-20 text-center ">
          <h1 class="text-6xl max-sm:text-3xl font-bold leading-tight mb-2 font-serif max-sm:mt-16">
            Welcome to Phoetech
          </h1>
          <p class="text-2xl max-sm:text-lg font-extralight text-gray-300 mb-4 font-poppins bg-clip-text tracking-wider text-transparent bg-gradient-to-r from-blue-500 to-teal-400">
            - Unleashing D2C Potential
          </p>
          <a
            href="#"
            className="font-medium inline-flex items-center justify-center border border-transparent rounded leading-snug transition duration-150 ease-in-out px-8 max-sm:px-6 py-3 max-sm:py-2 shadow-lg text-white bg-blue-600 hover:bg-blue-700 mb-4 sm:w-auto sm:mb-0 font-CooperHevitt"
          >
            Get Started
          </a>
        </div>
