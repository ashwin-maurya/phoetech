...
export default function Hero() {
  return (
    <>
      <div
        class="relative bg-gradient-to-r from-purple-600 to-blue-600 h-screen max-h-[800px] bg-center bg-cover bg-no-repeat text-white overflow-hidden bg-indigo-950"
        style={{
